...
func Test_parseResponse(t *testing.T) {
	...
	tests := []struct {
		...
		{"ibm.com", args{
			&dnsRequest{dnsmessage.TypeA, "ibm.com", time.Time{}, time.Time{}, nil},
		...
		{"cloudflare.com", args{
			&dnsRequest{dnsmessage.TypeAAAA, "cloudflare.com", time.Time{}, time.Time{}, nil},
		...
		{"empty/error", args{
			&dnsRequest{dnsmessage.TypeA, "empty", time.Time{}, time.Time{}, nil},
			[]byte{}},
			nil,
			true,
		},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := parseResponse(tt.args.req, nil, tt.args.payload)
